  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Comboboxes, multi-select, number fields, repeated values and file uploads.",
        href: "/advanced-form-controls",
        category: "Components",
        icon: ListPlus,
      },
      {
        title: "Combobox",
        description: "Async-ready searchable selection for application codebooks.",
        href: "/advanced-form-controls#combobox",
        category: "Advanced form controls",
        icon: ListPlus,
      },
      {
        title: "File upload",
        description: "Keyboard-accessible file selection and drag-and-drop.",
        href: "/advanced-form-controls#file-upload",
        category: "Advanced form controls",
        icon: ListPlus,
      },
      {
        title: "Feedback & states",
        description: "Alerts, statuses, loading, empty content and page-level results.",
        href: "/feedback",
        category: "Components",
        icon: CircleAlert,
      },
      {
        title: "Result states",
        description: "Consistent forbidden, not-found, error and success pages.",
        href: "/feedback#result-states",
